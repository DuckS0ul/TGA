...
import players.GroupT.BasicMCTSParams;
import players.GroupT.BasicTreeNode;
...
public class BasicMCTSPlayer extends AbstractPlayer {
    ...
    Random rnd;
    players.GroupT.BasicMCTSParams params;
    ...
    public BasicMCTSPlayer(long seed) {
        this.params = new players.GroupT.BasicMCTSParams(seed);
        rnd = new Random(seed);
        setName("Basic MCTS");
